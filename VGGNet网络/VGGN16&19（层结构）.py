##相较于ALetNet,其使用了更小的滤波器，并且使用了更深的结构；
##根据层数的不同可以分为VGG16、VGG19.
import torch
...
# Print the models to check their architecture
print(vgg16)
print(vgg19)


## 能够实现网络的层级结构后，在基于此进行MNSIT的数字识别的运算
...
vgg16_train_loss, vgg16_train_acc, vgg16_val_loss, vgg16_val_acc = train_model(vgg16, optimizer_vgg16, num_epochs=10)
torch.save(vgg16.state_dict(), "vgg16_mnist.pth")

# 训练VGG19模型
print("Training VGG19")
vgg19_train_loss, vgg19_train_acc, vgg19_val_loss, vgg19_val_acc = train_model(vgg19, optimizer_vgg19, num_epochs=10)
